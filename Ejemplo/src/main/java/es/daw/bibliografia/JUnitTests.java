...
public class JUnitTests {
	...
	public void getsDataAuthorExample() throws Exception {
		assertEquals(autorService.findOneByNombre("William Shakespeare").get().getNombre(), "William Shakespeare");
		assertEquals(autorService.findOneByNombre("William Shakespeare").get().getFecha_def(), "23 de abril 1616");
		assertEquals(autorService.findOneByNombre("William Shakespeare").get().getFecha_nac(), "26 de abril de 1564");
